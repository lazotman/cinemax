...
.shimmer{background:linear-gradient(90deg,${G.card} 25%,${G.border} 50%,${G.card} 75%);background-size:600px 100%;animation:shimmer 1.5s infinite;border-radius:${G.radius}}
